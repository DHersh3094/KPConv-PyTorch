...
class NeuesPalaisSampler(Sampler):
    """Sampler for SensatUrban"""

    def __init__(self, dataset: NeuesPalaisDataset):
...
def NeuesPalaisCollate(batch_data):
    return NeuesPalaisCustomBatch(batch_data)
