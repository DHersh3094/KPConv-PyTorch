...
if __name__ == "__main__":
    ...
    # Initialize datasets
    training_dataset = NeuesPalaisDataset(config, set="training", use_potentials=True)
    test_dataset = NeuesPalaisDataset(config, set="validation", use_potentials=True)

    # Initialize samplers
    training_sampler = NeuesPalaisSampler(training_dataset)
